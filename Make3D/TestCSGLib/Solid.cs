...
namespace TestCSGLib
{
    public class Solid
    {
        ...
        private static readonly PolygonsPerPlaneKeyComparer polygonsPerPlaneKeyComparer = new PolygonsPerPlaneKeyComparer();
    ...
    {
        private readonly PlaneFactory planefactory = new PlaneFactory(1.0e-5);
        private readonly Dictionary<string, PolygonShared> polygonsharedfactory = new Dictionary<string, PolygonShared>();
        private readonly VertexFactory vertexfactory = new VertexFactory(1.0e-5);
    ...
    internal class PlaneFactory
    {
        ...
        private readonly Dictionary<Key, Plane> lookuptable = new Dictionary<Key, Plane>(keyComparer);
    ...
    {
        private static readonly KeyComparer keyComparer = new KeyComparer();
        private readonly Dictionary<Key, Vertex> lookuptable = new Dictionary<Key, Vertex>(keyComparer);
        private readonly double multiplier;
