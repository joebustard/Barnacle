...
{
    internal class SplitLeftRightNode : SolidFunctionNode
    {
        public SplitLeftRightNode()
        {
            Label = "SplitLeftRight";
        }
                ...
                if (expressions != null)
                {
                    ...
                    if (result)
                    {
                        ...
                        else
                        {
                            ...
                            if (src != null)
                            {
                                Object3D part2 = src.SplitLeftRight(src.AbsoluteBounds.MidPoint().X);
