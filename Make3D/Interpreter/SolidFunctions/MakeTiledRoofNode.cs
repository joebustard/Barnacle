...
namespace ScriptLanguage
{
    internal class MakeTiledRoofNode : ExpressionNode
    {
        ...
        public MakeTiledRoofNode
            (
            ExpressionNode length, ExpressionNode height, ExpressionNode width, ExpressionNode tileLength, ExpressionNode tileHeight, ExpressionNode tileWidth, ExpressionNode gapBetweenTiles
            )
    {
            ...
            (ExpressionCollection coll)
    {
                ...
                this.gapBetweenTilesExp = coll.Get(6);
...
public override bool Execute()
{
    bool result = false;
                    ...
                    double valLength= 0;                double valHeight= 0;                double valWidth= 0;                double valTileLength= 0;                double valTileHeight= 0;                double valTileWidth= 0;                double valGapBetweenTiles= 0;
               ...
               EvalExpression(gapBetweenTilesExp, ref valGapBetweenTiles, "GapBetweenTiles", "MakeTiledRoof") )
    {
        ...
        if (inRange)
        {
            ...
            TiledRoofMaker maker = new TiledRoofMaker(valLength, valHeight, valWidth, valTileLength, valTileHeight, valTileWidth, valGapBetweenTiles);
