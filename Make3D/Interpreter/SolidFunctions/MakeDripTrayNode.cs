...
namespace ScriptLanguage
{
    internal class MakeDripTrayNode : ExpressionNode
    {
        ...
        public MakeDripTrayNode(ExpressionNode topLength,
                                 ...
                                 ExpressionNode trayHeight,
                                 ExpressionNode wallThickness)
        {
        ...
        public override bool Execute()
        {
            ...
            if (
               EvalExpression(topLengthExp, ref valTopLength, "TopLength", label) &&
               EvalExpression(topWidthExp, ref valTopWidth, "TopWidth", label) &&
               EvalExpression(baseLengthExp, ref valBaseLength, "BaseLength", label) &&
               EvalExpression(baseWidthExp, ref valBaseWidth, "BaseWidth", label) &&
               EvalExpression(trayHeightExp, ref valTrayHeight, "TrayHeight", label) &&
               EvalExpression(wallThicknessExp, ref valWallThickness, "WallThickness", label))
            {
