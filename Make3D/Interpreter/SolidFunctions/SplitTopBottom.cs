...
{
    internal class SplitTopBottomNode : SolidFunctionNode
    {
        public SplitTopBottomNode()
        {
            Label = "SplitTopBottom";
        }
                ...
                if (expressions != null)
                {
                    ...
                    if (result)
                    {
                        ...
                        else
                        {
                            ...
                            if (src != null)
                            {
                                Object3D part2 = src.SplitTopBottom(src.AbsoluteBounds.MidPoint().Y);
