...
{
    internal class SaveSolidNode : SolidStatement
    {
        public SaveSolidNode()
        {
            label = "SaveSolid";
            ...
            try
            {
                if (expressions != null)
                {
                    ...
                    if (result)
                    {
                        ...
                        {
                            Log.Instance().AddEntry($"Run Time Error : {label} solid id incorrect");
                        }
                    }
                }
            }
        ...
        public void Write(string file, int solidid)
        {
            GC.Collect();
            ...
            if (solidid >= 0 && solidid <= Script.ResultArtefacts.Count && Script.ResultArtefacts[solidid] != null)
            {
                Object3D ob = Script.ResultArtefacts[solidid];
                if (ob != null)
                {
