...
namespace ScriptLanguage
{
    internal class AdditionNode : ExpressionNode
    {
        ...
        // Copy constructor
        public AdditionNode(AdditionNode it)
        {
        }
                    ...
                    if (RightVal != null)
                    {
                        ...
                        if (LeftVal != null)
                        {
                            ...
                            if (LeftVal.MyType == RightVal.MyType)
                            {
                                ...
                                {
                                    ExecutionStack.Instance().Push((String)(LeftVal.StringValue + RightVal.StringValue));
                                }
                                else
                                {
                                    Log.Instance().AddEntry("Run Time Error : Adding together types that can't be added");
                                }
                            }
                            else
                            ...
                            if (LeftVal.MyType == StackItem.ItemType.dval && RightVal.MyType == StackItem.ItemType.ival)
                            {
                                ExecutionStack.Instance().Push((double)(LeftVal.DoubleValue + RightVal.IntValue));
                            }
                            else
                            {
                                Log.Instance().AddEntry("Run Time Error : Type Mismatch in add");
                            }
                        }
                    }
                }
