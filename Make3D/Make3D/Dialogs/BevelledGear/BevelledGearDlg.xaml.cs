...
namespace Barnacle.Dialogs
{
    ...
    /// </summary>
    public partial class BevelledGearDlg : BaseModellerDialog, INotifyPropertyChanged
    {
        ...
        private void SaveEditorParmeters()
        {
            ...
            EditorParameters.Set("BaseRadius", BaseRadius.ToString()); EditorParameters.Set("GearHeight", GearHeight.ToString()); EditorParameters.Set("ToothLength", ToothLength.ToString()); EditorParameters.Set("NumberOfTeeth", NumberOfTeeth.ToString()); EditorParameters.Set("BoreHoleRadius", BoreHoleRadius.ToString()); EditorParameters.Set("BaseThickness", BaseThickness.ToString()); EditorParameters.Set("FillBase", FillBase.ToString());
        }
