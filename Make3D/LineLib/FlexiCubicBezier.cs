...
namespace Barnacle.LineLib
{
    public class FlexiCubicBezier : FlexiSegment
    {
        ...
        {
            if (AxiesAlign(P0, P3, flexiPoints) == "H")
            {
                flexiPoints[P3].Y = flexiPoints[P0].Y;
            }
            else
            {
                flexiPoints[P3].X = flexiPoints[P0].X;
            }
        }
        ...
        internal override void Expand(List<FlexiSegment> segs, ObservableCollection<FlexiPoint> flexiPoints)
        {
            ...
            FlexiPoint fp1 = new FlexiPoint(flexiPoints[P3].X, flexiPoints[P3].Y);
            flexiPoints.Insert(P3, fp1);
            ...
            if (index >= 0 && index < segs.Count)
            {
                ...
                {
                    segs[i].PointInserted(P3, 2);
                }
                LineSegment preSeg = new LineSegment(P0, np0);
                LineSegment postSeg = new LineSegment(np3, np4);
